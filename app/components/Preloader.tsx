...
export default function Preloader() {
  return (
    <div className="fixed inset-0 z-9999 flex items-center justify-center bg-[#145EEE]">
      <div className="relative flex items-center justify-center w-72 h-72">
        ...
        <div className="relative z-10">
          <div className="flex h-20 w-20 items-center justify-center rounded-3xl bg-[#145EEE] text-white text-3xl font-bold">
            W
          </div>
        </div>
      </div>
