      ...
      <div className="mx-auto max-w-7xl lg:px-0 md:px-5 px-5">
        ...
        >
          ...
          <h2 className="mt-4 text-2xl lg:text-4xl md:text-3xl font-bold text-[#102A56]">
            ...
            <span className="block text-[#145EEE]">No hidden costs.</span>
          </h2>
        ...
        >
          {packages.map((pkg) => {
            ...
            return (
              ...
              >
                {pkg.featured && (
                  <div className="absolute left-1/2 top-0 -translate-x-1/2 -translate-y-1/2 rounded-full bg-[#145EEE] px-5 py-2 text-sm font-semibold text-white">
                    Most Popular
                  </div>
                )}
                ...
                <div
                  className={`rounded-t-3xl md:p-8 p-5 ${
                    pkg.featured ? "bg-[#145EEE] text-white" : "bg-white"
                  }`}
                >
                  <div
                    ...
                    {pkg.features.map((feature) => (
                      <div key={feature} className="flex items-center gap-3">
                        <div className="flex h-6 w-6 items-center justify-center rounded-full bg-blue-100">
                          <Check size={14} className="text-[#145EEE]" />
                        </div>
